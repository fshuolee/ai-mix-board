...
const ModelSelectorModal: React.FC<ModelSelectorModalProps> = ({
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} size="4xl" tall>
      <ModalHeader
        icon={<Sparkles />}
        tone="brand"
        title={
        ...
        subtitle={t('model.subtitle', locale)}
      >
        <button
          onClick={handleSyncClick}
          disabled={isSyncing}
          className="flex items-center gap-1.5 px-3 py-1.5 bg-gray-800 hover:bg-gray-700 text-gray-200 text-xs font-medium rounded-lg border border-gray-700 transition-colors shadow-sm disabled:opacity-50 cursor-pointer"
      ...
      <ModalFooter className="justify-between text-xs text-gray-400">
        ...
        <ModalButton variant="secondary" onClick={onClose} className="shrink-0">
