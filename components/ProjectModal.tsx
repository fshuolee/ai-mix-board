...
import { FolderPlus, Folder, FileSpreadsheet, Loader2, HardDrive } from 'lucide-react';
...
const ProjectModal: React.FC<ProjectModalProps> = ({
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} size="xl" busy={isCreating}>
      <ModalHeader
        icon={<HardDrive />}
        tone="emerald"
        title="專案管理 (Google Drive)"
        subtitle={
          <>
      ...
      <ModalFooter>
        <ModalButton variant="secondary" onClick={onClose} disabled={isCreating}>
          完成
        </ModalButton>
      </ModalFooter>
    </Modal>
